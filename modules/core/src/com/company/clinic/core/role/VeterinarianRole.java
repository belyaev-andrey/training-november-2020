...
@Role(name = VeterinarianRole.NAME, description = "Veteriarian Role")
public class VeterinarianRole extends AnnotatedRoleDefinition {
    ...
    @EntityAttributeAccess(entityClass = Visit.class, modify = {"hoursSpent", "consumables", "description"}, view = "*")
